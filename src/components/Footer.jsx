    ...
    <>
      ...
      <footer className="container-fluid pt-3">
        <div className="container-lg d-flex flex-column justify-content-center align-items-center footer-content mb-3">
          <div className="footer-title mb-3 mt-3 fw-bold h5">
            Shop Safely and Securely
          </div>
          <div className="footer para mb-2">
            <address>
        ...
        <div className="container-lg footer-trivial-info mb-3 d-flex justify-content-between">
